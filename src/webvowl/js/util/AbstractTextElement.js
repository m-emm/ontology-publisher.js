...
function AbstractTextElement(container, backgroundColor,additionalClasses) {
	var textBlock = container.append("text");
	textBlock.classed("text", true)
		.style("fill", this._getTextColor(backgroundColor))
		.attr("text-anchor", "middle");
	if(additionalClasses) {
		additionalClasses.forEach(function(e) {
			textBlock.classed(e,true);
		});
	}
