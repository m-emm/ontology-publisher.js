...
module.exports = (function () {
	...
	var Base = function (graph) {
		...
		this.inferred = function (p) {
			if (!arguments.length) return inferred;
			inferred = p;
			return this;
		};
		...
		this.drawLabel = function (labelContainer) {
			...
			var classArray= that.visualAttributes();
			var textElement = new CenteringTextElement(labelContainer, this.backgroundColor(),classArray);
